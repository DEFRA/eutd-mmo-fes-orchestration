...
export default class ExportPayloadController {
  ...
  public static async preCheckCertificate(userPrincipal: string, documentNumber: string, exportPayload: PayloadSchema.ProductsLanded, contactId: string, providedDraft?: CatchCertificate):
  ...
  public static async createExportCertificate(req: Hapi.Request, h: Hapi.ResponseToolkit<Hapi.ReqRefDefaults>, userPrincipal: string, documentNumber: string, contactId: string, providedDocument?: CatchCertificate) {
    try {
  ...
  public static async getLandingsType(userPrincipal: string, documentNumber: string, contactId: string, providedDraft?: CatchCertificate): Promise<{ landingsEntryOption: string, generatedByContent: boolean }> {
