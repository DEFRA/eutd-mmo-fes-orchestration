...
export default class CertificateController {
  public static async getSummaryCertificate(req: Hapi.Request, h: Hapi.ResponseToolkit<Hapi.ReqRefDefaults>, userPrincipal: string, documentNumber: string, providedDocument?: CatchCertificate): Promise<CertificateSummary> {
    ...
    const document: CatchCertificate = providedDocument ?? await getDocument(documentNumber, userPrincipal, contactId)
      .catch(e => {
