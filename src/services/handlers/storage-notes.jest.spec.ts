...
import { MAX_TRANSPORT_UNLOADED_FROM_LENGTH } from "../constants";
...
describe("/create-storage-document/:documentNumber/add-UK-entry-document", () => {
  let mockValidatorSpeciesName;
  ...
  it("with all mandatory fields validates as OK", async () => {
    const currentUrl =
      "/create-storage-document/:documentNumber/add-UK-entry-document";
    const handler = StorageNotes[currentUrl];
    ...
    const { errors } = await handler({
      ...
      _currentUrl: currentUrl,
      errors: {},
      documentNumber: 'GBR-2023-SD-01234ABCD',
      userPrincipal: 'bob',
      contactId: 'contactId'
    });
  ...
  it("with future date for date of unloading", async () => {
    ...
    expect(errors).toBeTruthy();
    expect(errors).toEqual({
      "catches-0-dateOfUnloading": "sdAddProductToConsignmentDateOfUnloadingErrorValidDate",
    });
  });
  ...
  it("should return an error if the document references a UK certificate number that is incomplete or void", async () => {
    mockValidateCompletedDocument.mockResolvedValue(false);

    const currentUrl = "/create-storage-document/:documentNumber/add-UK-entry-document";
    const handler = StorageNotes[currentUrl];
      ...
      catches: [
        {
          ...
          product: "Atlantix",
          commodityCode: "34234324",
          certificateNumber: "GBR-2022-CC-BEFCD6036",
          productWeight: "1111",
          dateOfUnloading: "29/01/2022",
          placeOfUnloading: "Dover",
          transportUnloadedFrom: "TRANS-IN-001",
          certificateType: "uk"
        },
    ...
    const { errors } = await handler({
      ...
      _currentUrl: currentUrl,
      errors: {},
      documentNumber: 'GBR-2022-SD-BEFCD6036',
      userPrincipal: 'bob',
      contactId: 'contactId'
    });
  ...
  it("should return an error if the document references a UK certificate number for which the species is not present", async () => {
    ...
    expect(mockValidateSpecies).toHaveBeenCalledWith('GBR-2022-CC-BEFCD6036', 'Atlantix', null, 'bob', 'contactId', 'GBR-2022-SD-BEFCD6036')
    expect(errors).toBeTruthy();
    expect(errors).toEqual({
  ...
  it("should return an error when the document number is of type UK and it is in an invalid format", async () => {
    const currentUrl =
      "/create-storage-document/:documentNumber/add-UK-entry-document";
    const handler = StorageNotes[currentUrl];
      ...
      catches: [
        {
          ...
          placeOfUnloading: "Dover",
          transportUnloadedFrom: "TRANS-IN-001",
          certificateNumber: "GBR-2023-ZX-7C7D66D16",
          certificateType: "uk"
        },
      ],
      storageFacilities: [{}],
  ...
  it("should return an error when the document number is of type UK and it is void", async () => {
    const currentUrl =
      "/create-storage-document/:documentNumber/add-UK-entry-document";
    const handler = StorageNotes[currentUrl];
  ...
  it("with missing date product entered the UK validates as error", async () => {
    ...
    const expected = {
      "catches-0-dateOfUnloading": "sdAddProductToConsignmentDateOfUnloadingErrorNull",
    };
  ...
  it("with missing place product entered the UK validates as error", async () => {
    ...
    const expected = {
      "catches-0-placeOfUnloading": "sdAddProductToConsignmentPlaceOfUnloadingErrorNull",
    };
  ...
  it("with incorrect place product entered the UK validates as error", async () => {
    ...
    const expected = {
      "catches-0-placeOfUnloading": "sdAddProductToConsignmentPlaceOfUnloadingErrorInvalid"
    };

    expect(errors).toBeTruthy();
    expect(errors).toEqual(expected);
  });
  it("should return an error when the number of characters in the placeproduct entered the UK exceeds the threshold", async () => {
    const currentUrl =
      "/create-storage-document/:documentNumber/add-UK-entry-document";
    const handler = StorageNotes[currentUrl];
      ...
      catches: [
        {
          ...
          dateOfUnloading: "29/01/2019",
          transportUnloadedFrom: "TRANS-IN-001",
          placeOfUnloading: "testsetsttestseteststeeseestststsesessetststsesteststestseestststeststestetsetstsettset"
        },
      ],
      storageFacilities: [{}],
      addAnotherProduct: "notset",
    ...
    const expected = {
      "catches-0-placeOfUnloading": "sdAddProductToConsignmentPortErrorMustNotExceed"
    };
  ...
  it("with missing transport details validates as error", async () => {
    ...
    const expected = {
      "catches-0-transportUnloadedFrom": "sdAddProductToConsignmentTransportDetailsErrorNull",
    };
  ...
  it("will throw error if length of transportUnloadedFrom is grester than max length", async () => {
    const currentUrl =
      "/create-storage-document/:documentNumber/add-UK-entry-document";
    const handler = StorageNotes[currentUrl];
      ...
      catches: [
        {
          ...
          dateOfUnloading: "29/01/2019",
          placeOfUnloading: "Dover",
          transportUnloadedFrom: "testsetsttestseteststeeseestststsesessetststsesteststestseestststeststestetsetstsettsetestsetestestestsetsetestseteststestseteststsettestsetestsetsetsetstststststsetestse"
        },
      ],
      storageFacilities: [{}],
      addAnotherProduct: "notset",
    ...
    const expected = {
      "catches-0-transportUnloadedFrom": `sdAddProductToConsignmentTransportDetailsErrorMustNotExceed-${MAX_TRANSPORT_UNLOADED_FROM_LENGTH}`,
    };
  ...
  it("will throw error if  transportUnloadedFrom is invalid format", async () => {
    const currentUrl =
      "/create-storage-document/:documentNumber/add-UK-entry-document";
    const handler = StorageNotes[currentUrl];
    ...
    const expected = {
      "catches-0-transportUnloadedFrom": 'sdAddProductToConsignmentTransportDetailsErrorInValidFormat',
    };
  ...
  it("with whitespace certificateNumber, placeOfUnloading and transportUnloadedFrom validates as error", async () => {
    const currentUrl =
      "/create-storage-document/:documentNumber/add-UK-entry-document";
    const handler = StorageNotes[currentUrl];
...
describe("/create-storage-document/:documentNumber/add-UK-entry-document/:index", () => {
  let mockValidatorSpeciesName;
  ...
  it("with all mandatory fields validates as OK", async () => {
    const currentUrl =
      "/create-storage-document/:documentNumber/add-UK-entry-document/:index";
    const handler = StorageNotes[currentUrl];
...
describe("/create-storage-document/:documentNumber/add-document-type", () => {
  ...
  it("with missing storageFacilities validates as error", async () => {
    const currentUrl =
      "/create-storage-document/:documentNumber/add-document-type";
    const handler = StorageNotes[currentUrl];
    ...
    const expectedErrors = {
      "document-0-certificateType": "sdAddCatchTypeErrorSelectCertificateType",
    };
...
describe("/create-storage-document/:documentNumber/add-document-type/:productIndex", () => {
  const data = {
    catches: [
      {
        weightOnCC: "2222",
  ...
  it("with missing storageFacilities validates as error", async () => {
    const currentUrl =
      "/create-storage-document/:documentNumber/add-document-type/:productIndex";
    const handler = StorageNotes[currentUrl];
...
describe("/create-storage-document/:documentNumber/add-document-type/:productIndex with invalid certificateType", () => {
  const data = {
    catches: [
      {
        weightOnCC: "2222",
  ...
  it("with missing storageFacilities validates as error", async () => {
    ...
    const expectedErrors = {
      "document-0-certificateType": "sdAddCatchTypeErrorCertificateTypeInvalid",
    };
