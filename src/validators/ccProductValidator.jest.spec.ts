...
describe('product validators', () => {
  ...
  describe('seasonalFish', () => {
    ...
    it('multiple products', async () => {
      ...
      const products = [{
        "product": { "id": "771937fc-e62c-49f8-a4c6-acab6111fbdb", "commodityCode": "03063210", "presentation": { "code": "WHL", "label": "Whole" }, "state": { "code": "ALI", "label": "Alive" }, "species": { "code": "LBE", "label": "European lobster (LBE)" } },
        "landings": [{
          "model": { "id": "badf8e6e-530b-40e2-be5e-41a33d0fa59a", "vessel": { "pln": "LO574", "vesselName": "ABBIE LOU", "flag": "GBR", "homePort": "LEIGH-ON-SEA", "licenceNumber": "25893", "imoNumber": null, "licenceValidTo": "2382-12-31T00:00:00", "rssNumber": "C18644", "vesselLength": 9.95, "label": "ABBIE LOU (LO574)", "domId": "ABBIELOU-LO574" }, "dateLanded": "2019-02-15T00:00:00.000Z", "exportWeight": 88, "faoArea": "FAO27" }
        }]
      }, { "product": { "id": "715a3214-2412-448e-a7df-f25f893856a7", "commodityCode": "03025600", "presentation": { "code": "FIS", "label": "Filleted and skinned" }, "state": { "code": "FRE", "label": "Fresh" }, "species": { "code": "WHB", "label": "Blue whiting(=Poutassou) (WHB)" } }, "landings": [{ "model": { "id": "48181049-7d00-4f69-9f2b-90348205b648", "vessel": { "pln": "LO406", "vesselName": "ANTON SCOTT", "flag": "GBR", "homePort": "LEIGH-ON-SEA", "licenceNumber": "20933", "imoNumber": null, "licenceValidTo": "2382-12-31T00:00:00", "rssNumber": "A18724", "vesselLength": 8.7, "label": "ANTON SCOTT (LO406)", "domId": "ANTONSCOTT-LO406" }, "dateLanded": "2019-11-17T00:00:00.000Z", "exportWeight": 22, "faoArea": "FAO27" } }] }]
