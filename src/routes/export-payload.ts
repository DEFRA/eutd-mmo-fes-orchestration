          ...
          options: {
            ...
            handler: async (request, h) => {
              return await withDocumentLegitimatelyOwned(request, h, async (userPrincipal, documentNumber, contactId, document) => {
                ...
                return await Controller.createExportCertificate(request, h, userPrincipal, documentNumber, contactId, document as CatchCertificate);
            ...
            handler: async (request, h) => {
              return await withDocumentLegitimatelyOwned(request, h, async (userPrincipal, documentNumber, contactId, document) => {
                ...
                if (service === ServiceNames.CC) {
                  ...
                  return await Controller.getLandingsType(userPrincipal, documentNumber, contactId, document as CatchCertificate);
                }
