...
test('#documentNumberService.getDocumentNumber', (t) => {
  ...
  t.equal(true, true, '#documentNumberService.getDocumentNumber');
  t.end();
...
test('DocumentNumberService.createDocumentNumber', async (t) => {
  ...
  t.equal(true, result);
  t.equal(true, true, 'DocumentNumberService.createDocumentNumber');
  t.end();
});
...
test('DocumentNumberService.getDocument', async (t) => {
  ...
  t.equal(true, true, 'DocumentNumberService.getDocument');
  t.end();
});